...
Array.prototype.product=function(f){f=f||function(i){return i};return this.reduce(function(p,n){return p*f(n)},1)}
...
Array.prototype.min=function(f){f=f||function(i){return i};return this.reduce(function(m,n){if(f(n)<f(m))return n;return m})}
...
Array.prototype.matches=function(o){return this.filter(function(i){return i.isMatch(o)})}
...
Array.prototype.same=function(f){f=f||function(i){return i};var m,i,t=this;for(i=0;i<t.length;i++){if(m===undefined)m=f(t[i]);else if(m!=f(t[i]))return !1;}return!0}
...
Object.prototype.isMatch=function(o){for(var k in o)if(o.hasOwnProperty(k)){if(o[k] instanceof Object){if(!this[k].isMatch(o[k]))return !1}else if(this[k]!==o[k])return !1}return !0}
